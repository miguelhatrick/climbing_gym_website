...
class WebMemberMembership(models.Model):
    """Member Membership of each climbing gym member Web addition"""
    _inherit = ['climbing_gym.member_membership', 'portal.mixin']
    ...
    def _compute_access_url(self):
        super(WebMemberMembership, self)._compute_access_url()
        for myobject in self:
            myobject.access_url = '/my/member_memberships/%s' % myobject.id
