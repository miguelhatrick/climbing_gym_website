...
class CustomerPortal(CustomerPortal):
    ...
    def portal_my_reservations(self, page=1, date_begin=None, date_end=None, sortby=None, **kw):
        ...
        EventReservation = request.env['event.registration']
        ...
        searchbar_sortings = {
            'event': {'label': _('Event date'), 'order': 'event_id desc'},
            'date': {'label': _('Reserve Date'), 'order': 'create_date desc'},
        ...
        # count for pager
        quotation_count = EventReservation.search_count(domain)
        # make pager
        pager = portal_pager(
            url="/my/reservations",
        ...
        return request.render("climbing_gym_website.portal_my_reservations", values)
