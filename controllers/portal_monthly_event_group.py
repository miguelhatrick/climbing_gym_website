...
class CustomerPortal(CustomerPortal):
    ...
    def portal_my_monthly_event_groups(self, page=1, date_begin=None, date_end=None, sortby=None, **kw):
        ...
        return request.render("climbing_gym_website.portal_my_monthly_event_groups", values)
    ...
    def portal_my_monthly_event_form(self, group_id, **kw):
        ...
        return request.render("climbing_gym_website.portal_my_event_monthly_group_form", values)
